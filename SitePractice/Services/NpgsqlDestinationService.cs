...
namespace SitePractice.Services
{
    ...
    public class NpgsqlDestinationService
    {
        ...
        {
            get { return "Host=localhost:1234;Username=admin;Password=admin;Database=TestDB"; }
        }

        public NpgsqlDestinationService(IWebHostEnvironment webHostEnvironment)
        {
